...
<div class="pa-3"> 
    <router-link :to="{ name: 'admin-edit-profile' }" tag="v-btn" class=" text-decoration-none" > <v-btn
    block
  ...
  <router-link :to="{ name: 'admin-edit-contacts' }" tag="v-btn" class=" text-decoration-none" >
  <v-btn
  block
  class=" mt-2 rounded-pill"
  color="secondary"
...
<router-link :to="{ name: 'admin-edit-address' }" tag="v-btn" class=" text-decoration-none" >
    <v-btn
    block
    class=" mt-2 rounded-pill"
    color="secondary"
  ...
  <router-link :to="{ name: 'admin-security' }" tag="v-btn" class=" text-decoration-none" >
    <v-btn
    block
    class=" mt-2 rounded-pill"
    color="secondary"
